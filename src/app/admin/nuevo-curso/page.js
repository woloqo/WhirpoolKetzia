...
export default function NuevoCurso() {
  ...
  return (
    <div className="w-full font-sans bg-slate-50/30">
      
      <div className="grid grid-cols-3 p-4 items-center mb-4 border-b border-slate-100">
        <div className="flex justify-start">
          <Link href="/admin" className="p-4 inline-flex items-center gap-2 text-slate-400 hover:text-blue-600 transition-all font-bold text-xs uppercase tracking-widest group">
